...
`.trim();
  ...
  const MATCH_SYNONYMS = [
    ...
    ["szalloda", "hotel"],
    ["szallashely", "lodging"],
    ["taxiszolgaltatas", "taxi"],
    ["futarszolgalat", "courier"],
    ["hazhozszallitas", "delivery"],
    ["rendezveny", "events"],
    ["piac", "market"],
    ["kiskereskedelem", "retail"],
    ["nagykereskedelem", "wholesale"],
    ["javitas", "repair"],
    ["karbantartas", "repair"],
    ["gepjarmu", "automobile"],
    ["epitoipar", "contractor"],
    ["ingatlan", "real estate"],
    ["szamvitel", "accounting"],
    ["konyvvizsgalat", "accounting"],
    ["tanacsadas", "consulting"],
    ["fotografia", "photography"],
    ["fenykepeszet", "photography"],
    ["muvészet", "art"],
    ["muveszet", "art"],
    ["gyogyszer", "pharmacy"],
    ["egeszsegugy", "medical"],
    ...
    ["szallitas", "transportation"],
    ["raktarozas", "warehouse"],
    ["biztonsagi", "security"],
    ["utazas", "travel"],
    ["utazasi", "travel"],
    ["divat", "apparel"],
  ...
  const MCC_DB_EN = MCC_DB_SOURCE_EN.split("\n").slice(1).map((line) => {
    const [category, activity, mcc, description] = line.split("\t");
    return {
      category: (category || "").trim(),
      activity: (activity || "").trim(),
  ...
  const TEAOR_DB = new Map([
    ...
    ['01.24', 'Almatermésű, csonthéjas gyümölcs termesztése'],
    ['01.25', 'Egyéb fatermésű, héjas gyümölcs termesztése'],
    ['01.26', 'Olajtartalmú gyümölcs termesztése'],
    ['01.27', 'Italgyártásra szolgáló növényi termék termesztése'],
    ['01.28', 'Fűszer-, aroma-, gyógynövény termesztése'],
    ['01.29', 'Egyéb évelő növény termesztése'],
    ['01.30', 'Növényi szaporítóanyag termesztése'],
    ['01.41', 'Tejelő szarvasmarha tenyésztése'],
    ['01.42', 'Más szarvasmarha tenyésztése'],
    ['01.43', 'Ló, lóféle tenyésztése'],
    ['01.44', 'Teveféle tenyésztése'],
    ...
    ['01.64', 'Vetőmagfeldolgozás'],
    ['01.70', 'Vadászat, vadgazdálkodás'],
    ...
    ['03.21', 'Tengeri halgazdálkodás'],
    ['03.22', 'Édesvízi halgazdálkodás'],
    ['05.10', 'Feketekőszén-bányászat'],
    ['05.20', 'Barnakőszén-bányászat'],
    ['06.10', 'Kőolaj-kitermelés'],
    ['06.20', 'Földgázkitermelés'],
    ['07.10', 'Vasércbányászat'],
    ['07.21', 'Urán-, tóriumérc-bányászat'],
    ['07.29', 'Egyéb színesfémérc-bányászat'],
    ['08.11', 'Díszítőkő, építőkő bányászata'],
    ['08.12', 'Kavics-, homokbányászat'],
    ['08.91', 'Vegyipari ásvány bányászata'],
    ['08.92', 'Tőzegkitermelés'],
    ['08.93', 'Sókitermelés'],
    ['08.99', 'Egyéb bányászat'],
    ['09.10', 'Kőolaj-, földgázkitermelési szolgáltatás'],
    ['09.90', 'Egyéb bányászati szolgáltatás'],
    ['10.11', 'Húsfeldolgozás, -tartósítás'],
    ['10.12', 'Baromfihús feldolgozása, tartósítása'],
    ['10.13', 'Húskészítmény gyártása'],
    ...
    ['11.01', 'Desztillált szeszes ital előállítása'],
    ['11.02', 'Szőlőbor termelése'],
    ['11.03', 'Almabor, gyümölcsbor termelése'],
    ['11.04', 'Egyéb nem desztillált, erjesztett ital előállítása'],
    ['11.05', 'Sörgyártás'],
    ['11.06', 'Malátagyártás'],
    ['11.07', 'Üdítőital gyártása'],
    ['12.00', 'Dohánytermék gyártása'],
    ['13.10', 'Textilszálak fonása'],
    ['13.20', 'Textilszövés'],
    ['13.30', 'Textilkikészítés'],
    ['13.91', 'Kötött kelme gyártása'],
    ['13.92', 'Textiltermék gyártása'],
    ['13.93', 'Szőnyeggyártás'],
    ['13.94', 'Kötéláru gyártása'],
    ['13.95', 'Nem szőtt textília és termék gyártása'],
    ['13.96', 'Műszaki, textiláru gyártása'],
    ['13.99', 'Egyéb textiláru gyártása'],
    ['14.11', 'Bőrruházat gyártása'],
    ['14.12', 'Munkaruházat gyártása'],
    ['14.13', 'Felsőruházat gyártása (kivéve: munkaruházat)'],
    ['14.14', 'Fehérnemű gyártása'],
    ['14.19', 'Egyéb ruházat, kiegészítő gyártása'],
    ['14.20', 'Szőrmecikk gyártása'],
    ['14.31', 'Harisisnya, kötöttáru gyártása'],
    ['14.39', 'Egyéb kötött, hurkolt ruházati cikk gyártása'],
    ['15.11', 'Bőr, szőrme kikészítése'],
    ['15.12', 'Bőrárugyártás, szíjgyártás'],
    ['15.20', 'Lábbeligyártás'],
    ['16.10', 'Fűrészárugyártás'],
    ['16.21', 'Falemezgyártás'],
    ['16.22', 'Ácsolt faépítmény gyártása'],
    ['16.23', 'Ácsterék, parketta gyártása'],
    ['16.24', 'Tároló fatermék gyártása'],
    ['16.29', 'Egyéb fa-, parafatermék, fonottáru gyártása'],
    ['17.11', 'Cellulózgyártás'],
    ['17.12', 'Papírgyártás'],
    ['17.21', 'Hullámpapír gyártása'],
    ['17.22', 'Háztartási, egészségügyi papírtermék gyártása'],
    ['17.23', 'Irodai papíráru gyártása'],
    ['17.24', 'Tapétagyártás'],
    ['17.29', 'Egyéb papír-, kartontermék gyártása'],
    ['18.11', 'Nyomdai tevékenység'],
    ['18.12', 'Nyomást kiegészítő tevékenység'],
    ['18.13', 'Nyomdai szolgáltatás'],
    ['18.14', 'Könyvkötés, kapcsolódó szolgáltatás'],
    ['18.20', 'Adathordozó sokszorosítása'],
    ['19.10', 'Kokszgyártás'],
    ['19.20', 'Kőolaj-feldolgozás'],
    ['20.11', 'Ipari gáz gyártása'],
    ['20.12', 'Színezék, pigment gyártása'],
    ['20.13', 'Egyéb szervetlen vegyi alapanyag gyártása'],
    ['20.14', 'Egyéb szerves vegyi alapanyag gyártása'],
    ['20.15', 'Műtrágya-, nitrogénvegyület gyártása'],
    ['20.16', 'Műanyag alapanyag gyártása'],
    ['20.17', 'Szintetikus kaucsuk alapanyag gyártása'],
    ['20.20', 'Növényvédőszer gyártása'],
    ['20.30', 'Festék, bevonóanyag gyártása'],
    ['20.41', 'Szappan, tisztálkodószer gyártása'],
    ['20.42', 'Testápoló, illatszer gyártása'],
    ['20.51', 'Robbanóanyag gyártása'],
    ['20.52', 'Ragasztó gyártása'],
    ['20.53', 'Illóolaj gyártása'],
    ...
    ['22.11', 'Gumiabroncs gyártása'],
    ['22.19', 'Egyéb gumitermék gyártása'],
    ['22.21', 'Műanyag lap, lemez gyártása'],
    ['22.22', 'Műanyag csomagolóeszköz gyártása'],
    ['22.23', 'Műanyag építőanyag gyártása'],
    ['22.29', 'Egyéb műanyag termék gyártása'],
    ['23.11', 'Üreges üveg gyártása'],
    ['23.12', 'Síküveggyártás'],
    ['23.13', 'Öblösüveggyártás'],
    ['23.14', 'Üvegáru gyártása'],
    ['23.19', 'Egyéb üvegtermék gyártása'],
    ['23.20', 'Tűzálló termék gyártása'],
    ['23.31', 'Kerámia falburkoló gyártása'],
    ['23.32', 'Égetett agyag építőanyag gyártása'],
    ['23.41', 'Kerámia háztartási cikk gyártása'],
    ['23.42', 'Kerámia egészségügyi termék gyártása'],
    ['23.43', 'Kerámia szigetelő gyártása'],
    ['23.44', 'Kerámia műszaki áru gyártása'],
    ['23.49', 'Egyéb kerámia termék gyártása'],
    ['23.51', 'Cementgyártás'],
    ['23.52', 'Més-, gipszgyártás'],
    ['23.61', 'Betontermék gyártása'],
    ['23.62', 'Gipsztermék gyártása'],
    ['23.63', 'Friss beton gyártása'],
    ['23.64', 'Habarcsgyártás'],
    ['23.65', 'Szálerősítésű cement termék gyártása'],
    ['23.69', 'Egyéb beton-, gipsz-, cementtermék gyártása'],
    ['23.70', 'Kőmegmunkálás'],
    ['23.91', 'Csiszolótermék gyártása'],
    ['23.99', 'M.n.s. egyéb ásványi termék gyártása'],
    ['24.10', 'Vas-, acélgyártás'],
    ['24.20', 'Acélcsőgyártás'],
    ['24.31', 'Hidegen húzott rúd gyártása'],
    ['24.32', 'Hidegen hengerelt acél gyártása'],
    ['24.33', 'Hidegen alakított acélgyártás'],
    ['24.34', 'Hidegen húzott huzal gyártása'],
    ...
    ['24.54', 'Egyéb fémöntés'],
    ['25.11', 'Fémszerkezet gyártása'],
    ['25.12', 'Fém építési termék gyártása'],
    ['25.21', 'Központi fűtési kazán gyártása'],
    ['25.29', 'Fémtartály gyártása'],
    ['25.30', 'Gőzkazán gyártása'],
    ['25.40', 'Fegyver-, lőszergyártás'],
    ['25.50', 'Fémalakítás'],
    ['25.61', 'Fém felületkezelése'],
    ['25.62', 'Fémmegmunkálás'],
    ['25.71', 'Evőeszköz gyártása'],
    ['25.72', 'Lakatosáru gyártása'],
    ['25.73', 'Szerszámgyártás'],
    ['25.91', 'Fém tárolóeszköz gyártása'],
    ['25.92', 'Csomagolóeszköz gyártása'],
    ['25.93', 'Huzaltermék gyártása'],
    ['25.94', 'Kötőelem gyártása'],
    ['25.99', 'M.n.s. egyéb fémtermék gyártása'],
    ['26.11', 'Elektronikai alkatrész gyártása'],
    ['26.12', 'Elektronikai áramköri kártya gyártása'],
    ['26.20', 'Számítógép, periféria gyártása'],
    ['26.30', 'Híradástechnikai berendezés gyártása'],
    ['26.40', 'Elektronikai fogyasztási cikk gyártása'],
    ['26.51', 'Mérőműszergyártás'],
    ['26.52', 'Óragyártás'],
    ['26.60', 'Sugárzó, elektro- és terápiás berendezés gyártása'],
    ['26.70', 'Optikai eszköz gyártása'],
    ['26.80', 'Mágneses, optikai média gyártása'],
    ['27.11', 'Villamos motor, áramfejlesztő gyártása'],
    ['27.12', 'Áramelosztó, szabályozó készülék gyártása'],
    ['27.20', 'Áramforrás gyártása'],
    ['27.31', 'Optikai kábel gyártása'],
    ['27.32', 'Egyéb elektronikus, villamos kábel gyártása'],
    ['27.33', 'Huzalozott készülékek gyártása'],
    ['27.40', 'Villamos világítóeszköz gyártása'],
    ['27.51', 'Háztartási készülék gyártása'],
    ['27.52', 'Nem háztartási elektromos berendezés gyártása'],
    ['27.90', 'Egyéb villamos berendezés gyártása'],
    ['28.11', 'Motor, turbina gyártása'],
    ['28.12', 'Hidraulikus, pneumatikus berendezés gyártása'],
    ['28.13', 'Szivattyú, kompresszor gyártása'],
    ['28.14', 'Csap, szelep gyártása'],
    ['28.15', 'Csapágy, erőátviteli eszköz gyártása'],
    ['28.21', 'Kemence gyártása'],
    ['28.22', 'Emelőgép gyártása'],
    ['28.23', 'Irodagép gyártása'],
    ['28.24', 'Kézi szerszámgép gyártása'],
    ['28.25', 'Hűtő-, légkondicionáló gyártása'],
    ['28.29', 'M.n.s. egyéb általános rendeltetésű gép gyártása'],
    ['28.30', 'Mezőgazdasági, erdészeti gép gyártása'],
    ['28.41', 'Szerszámgép gyártása'],
    ['28.49', 'Egyéb szerszámgép gyártása'],
    ['28.91', 'Kohászati gép gyártása'],
    ['28.92', 'Bányászati, építőipari gép gyártása'],
    ['28.93', 'Élelmiszeripari gép gyártása'],
    ['28.94', 'Textil-, ruházati, bőripari gép gyártása'],
    ['28.95', 'Papíripari gép gyártása'],
    ['28.96', 'Műanyag, gumiipari gép gyártása'],
    ['28.99', 'M.n.s. egyéb speciális gép gyártása'],
    ['29.10', 'Gépjárműgyártás'],
    ['29.20', 'Gépjármű karosszéria, pótkocsi gyártása'],
    ['29.31', 'Gépjármű elektromos berendezés gyártása'],
    ['29.32', 'Gépjármű alkatrész gyártása'],
    ['30.11', 'Hajóépítés'],
    ['30.12', 'Szabadidős hajó gyártása'],
    ['30.20', 'Vasúti vontatású jármű gyártása'],
    ['30.30', 'Légi, űrjármű gyártása'],
    ['30.40', 'Katonai harci jármű gyártása'],
    ['30.91', 'Motorkerékpár gyártása'],
    ['30.92', 'Kerékpár gyártása'],
    ['30.99', 'Egyéb jármű gyártása'],
    ['31.01', 'Irodabútor gyártása'],
    ['31.02', 'Konyhabútor gyártása'],
    ['31.03', 'Ágybetétgyártás'],
    ['31.09', 'Egyéb bútor gyártása'],
    ['32.11', 'Érmegyártás'],
    ['32.12', 'Ékszergyártás'],
    ['32.13', 'Divatékszer gyártása'],
    ['32.20', 'Hangszergyártás'],
    ['32.30', 'Sporteszköz gyártása'],
    ['32.40', 'Játékgyártás'],
    ['32.50', 'Orvosi eszköz gyártása'],
    ['32.91', 'Seprű, kefe gyártása'],
    ['32.99', 'M.n.s. egyéb gyártása'],
    ['33.11', 'Fémfeldolgozó gép javítása'],
    ['33.12', 'Ipari gép, berendezés javítása'],
    ['33.13', 'Elektronikai, optikai eszköz javítása'],
    ['33.14', 'Villamos berendezés javítása'],
    ['33.15', 'Hajó, csónak javítása'],
    ['33.16', 'Légi, űrjármű javítása'],
    ['33.17', 'Egyéb jármű javítása'],
    ['33.19', 'Egyéb ipari berendezés javítása'],
    ['33.20', 'Ipari gép, berendezés üzembe helyezése'],
    ['35.11', 'Villamos energia termelése'],
    ['35.12', 'Villamosenergia-átvitel'],
    ...
    ['45.11', 'Személygépjármű, könnyűgépjármű kereskedelme'],
    ['45.19', 'Egyéb gépjármű kereskedelme'],
    ['45.20', 'Gépjárműjavítás, -karbantartás'],
    ['45.31', 'Gépjárműalkatrész, -tartozék kereskedeleme'],
    ['45.32', 'Gépjárműalkatrész, -tartozék kiskereskedeleme'],
    ['45.40', 'Motorkerékpár, -alkatrész kereskedelme, javítása'],
    ['46.11', 'Mezőgazdasági termék ügynöki nagykereskedelme'],
    ['46.12', 'Üzemanyag, fém, vegyi áru ügynöki nagykereskedelme'],
    ['46.13', 'Fa, építőanyag, szaniteráru ügynöki nagykereskedelme'],
    ['46.14', 'Gép, berendezés ügynöki nagykereskedelme'],
    ['46.15', 'Bútor, háztartási áru, fémáru ügynöki nagykereskedelme'],
    ['46.16', 'Textil, ruházat, cipő ügynöki nagykereskedelme'],
    ['46.17', 'Élelmiszer, ital, dohányáru ügynöki nagykereskedelme'],
    ['46.18', 'Egyéb termék ügynöki nagykereskedelme'],
    ['46.19', 'Vegyes termékkörű ügynöki nagykereskedelme'],
    ['46.21', 'Gabona, dohány, vetőmag, takarmány nagykereskedelme'],
    ['46.22', 'Virág, növény nagykereskedelme'],
    ['46.23', 'Élőállat nagykereskedelme'],
    ['46.24', 'Bőr, bőráru nagykereskedelme'],
    ['46.31', 'Gyümölcs, zöldség nagykereskedelme'],
    ['46.32', 'Hús, húskészítmény nagykereskedelme'],
    ['46.33', 'Tejtermék, tojás nagykereskedelme'],
    ['46.34', 'Ital nagykereskedelme'],
    ['46.35', 'Dohányáru nagykereskedelme'],
    ['46.36', 'Cukor, édesség, sütőipari termék nagykereskedelme'],
    ['46.37', 'Kávé, tea, kakaó, fűszer nagykereskedelme'],
    ['46.38', 'Egyéb élelmiszer nagykereskedelme'],
    ['46.39', 'Élelmiszer, ital, dohányáru vegyes nagykereskedelme'],
    ['46.41', 'Textiláru nagykereskedelme'],
    ['46.42', 'Ruházat, lábbeli nagykereskedelme'],
    ['46.43', 'Villamos háztartási készülék nagykereskedelme'],
    ['46.44', 'Porcelán-, üvegáru, tisztítószer nagykereskedelme'],
    ['46.45', 'Kozmetikum, tisztálkodószer nagykereskedelme'],
    ['46.46', 'Gyógyszer, gyógyászati termék nagykereskedelme'],
    ['46.47', 'Bútor, szőnyeg, világító berendezés nagykereskedelme'],
    ['46.48', 'Óra, ékszer nagykereskedelme'],
    ['46.49', 'Egyéb háztartási cikk nagykereskedelme'],
    ['46.51', 'Számítógép, periféria, szoftver nagykereskedelme'],
    ['46.52', 'Elektronikus, távközlési berendezés, alkatrész nagykereskedelme'],
    ['46.61', 'Mezőgazdasági gép, berendezés nagykereskedelme'],
    ['46.62', 'Szerszámgép nagykereskedelme'],
    ['46.63', 'Bányászati, építőipari gép nagykereskedelme'],
    ['46.64', 'Textilipari gép nagykereskedelme'],
    ['46.65', 'Irodabútor, irodagép nagykereskedelme'],
    ['46.66', 'Egyéb irodagép, -berendezés nagykereskedelme'],
    ['46.69', 'Egyéb gép, berendezés nagykereskedelme'],
    ['46.71', 'Üzem-, tüzelőanyag nagykereskedelme'],
    ['46.72', 'Fém, érc nagykereskedelme'],
    ['46.73', 'Fa-, építőanyag, szaniteráru nagykereskedelme'],
    ['46.74', 'Fémáru, szerelvény nagykereskedelme'],
    ['46.75', 'Vegyészeti termék nagykereskedelme'],
    ['46.76', 'Egyéb termelési célú termék nagykereskedelme'],
    ['46.77', 'Hulladék, törmelék nagykereskedelme'],
    ['46.90', 'Vegyes termékkörű nagykereskedelem'],
    ['47.11', 'Élelmiszer jellegű vegyes kiskereskedelem'],
    ['47.19', 'Egyéb nem szakosodott élelmiszer kiskereskedelem'],
    ['47.21', 'Zöldség, gyümölcs kiskereskedelem'],
    ['47.22', 'Hús-, húskészítmény kiskereskedelem'],
    ['47.23', 'Hal kiskereskedelem'],
    ...
    ['47.30', 'Gépjármű-üzemanyag kiskereskedelem'],
    ['47.41', 'Számítógép, periféria, szoftver kiskereskedelem'],
    ['47.42', 'Távközlési eszköz kiskereskedelem'],
    ['47.43', 'Audio-, videoberendezés kiskereskedelem'],
    ['47.51', 'Textil kiskereskedelem'],
    ['47.52', 'Vasáru, építőanyag kiskereskedelem'],
    ['47.53', 'Szőnyeg, fal-, padlóburkoló kiskereskedelem'],
    ['47.54', 'Villamos háztartási készülék kiskereskedelem'],
    ['47.59', 'Bútor, világítási eszköz, egyéb háztartási cikk kiskereskedelem'],
    ['47.61', 'Könyv kiskereskedelem'],
    ['47.62', 'Újság, papíráru kiskereskedelem'],
    ['47.63', 'Zenei, videofelvétel kiskereskedelem'],
    ['47.64', 'Sportszer kiskereskedelem'],
    ['47.65', 'Játék kiskereskedelem'],
    ['47.66', 'Virág kiskereskedelem'],
    ['47.71', 'Ruházat kiskereskedelem'],
    ['47.72', 'Lábbeli, bőráru kiskereskedelem'],
    ['47.73', 'Gyógyszer kiskereskedelem'],
    ['47.74', 'Egészségügyi termék kiskereskedelem'],
    ['47.75', 'Kozmetikum kiskereskedelem'],
    ['47.76', 'Óra, ékszer kiskereskedelem'],
    ['47.77', 'Optikai termék kiskereskedelem'],
    ['47.78', 'Egyéb m.n.s. új áru kiskereskedelem'],
    ['47.79', 'Használt áru kiskereskedelem'],
    ['47.81', 'Élelmiszer, ital, dohányáru piaci kiskereskedelem'],
    ['47.82', 'Textil, ruházat, lábbeli piaci kiskereskedelem'],
    ['47.89', 'Egyéb termék piaci kiskereskedelem'],
    ['47.91', 'Csomagküldő, internetes kiskereskedelem'],
    ['47.99', 'Egyéb nem bolti, piaci kiskereskedelem'],
    ['49.10', 'Vasúti személyszállítás, helyközi'],
    ['49.20', 'Vasúti áruszállítás'],
    ['49.31', 'Városi, elővárosi, közúti személyszállítás'],
    ['49.32', 'Taxiszolgáltatás'],
    ['49.39', 'Máshova nem sorolt szárazföldi személyszállítás'],
    ...
    ['59.11', 'Film, video gyártása'],
    ['59.12', 'Film, video gyártást kiegészítő tevékenység'],
    ['59.13', 'Film, video terjesztése'],
    ['59.14', 'Filmvetítés'],
    ['60.10', 'Rádióműsor-szolgáltatás'],
    ['60.20', 'Televízióműsor-szolgáltatás'],
    ...
    ['63.11', 'Adatfeldolgozás, webhoszting szolgáltatás'],
    ['63.12', 'Világháló-portáli szolgáltatás'],
    ['63.91', 'Hírügynökségi tevékenység'],
    ['63.99', 'M.n.s. egyéb információs szolgáltatás'],
    ['64.11', 'Központi banki tevékenység'],
    ['64.19', 'Egyéb monetáris közvetítés'],
    ['64.20', 'Vagyonkezelés (holding)'],
    ['64.30', 'Bizalmi vagyonkezelés'],
    ...
    ['70.10', 'Üzletviteli, vezetési tanácsadás'],
    ...
    ['73.12', 'Médiaügynöki tevékenység'],
    ...
    ['82.19', 'Fénymásolás, dokumentum előkészítés'],
    ...
    ['91.03', 'Történelmi hely, építmény, műtárgy védelme'],
    ['91.04', 'Növény-, állatkert, természetvédelem'],
    ...
    ['93.21', 'Vidámparki, szórakoztató parki tevékenység'],
    ['93.29', 'Egyéb szórakoztatás, szabadidős tevékenység'],
    ['94.11', 'Üzleti, munkaadói érdekképviselet'],
    ...
    ['95.11', 'Számítógép, kommunikációs eszköz javítása'],
    ['95.12', 'Kommunikációs eszköz javítása'],
    ['95.21', 'Elektronikai berendezés javítása'],
    ['95.22', 'Háztartási gép, készülék javítása'],
    ['95.23', 'Lábbeli, bőráru javítása'],
    ['95.24', 'Bútor javítása'],
    ['95.25', 'Óra, ékszer javítása'],
    ...
    ['98.10', 'Háztartás termék-előállítása saját fogyasztásra'],
  ...
  function extractTeaorCode(value) {
    if (!value) return "";
    const match = value.match(/\b(\d{2})[.\s]?(\d{2})\b/);
    if (!match) return "";
    return `${match[1]}.${match[2]}`;
  }

  function stripTeaorCode(value) {
    if (!value) return "";
    return normalizeSpace(value.replace(/\b\d{2}[.\s]?\d{2}\b/g, " "));
  }

  function expandMatchText(text) {
    if (!text) return "";
    const normalized = normalizeForMatch(text);
    let expanded = text;
    MATCH_SYNONYMS.forEach(([from, to]) => {
      if (!from || !to) return;
      if (normalized.includes(normalizeForMatch(from))) {
        expanded += ` ${to}`;
      }
    });
    return expanded;
  ...
  const MCC_MATCH_INDEX = MCC_DB.map((entry, idx) => {
    const en = MCC_DB_EN[idx] || {};
    const matchText = [
      entry.category,
      entry.activity,
      entry.description,
    ...
    return {
      entry,
      tokens: new Set(tokenizeForMatch(expandMatchText(matchText)))
    };
  });
  ...
  function matchActivitiesToMcc(activities) {
    const results = [];
    activities.forEach((activity) => {
      const teaorCode = extractTeaorCode(activity);
      const teaorDescription = teaorCode ? TEAOR_DB.get(teaorCode) : "";
      const cleanedActivity = stripTeaorCode(activity);
      const matchText = [activity, cleanedActivity, teaorDescription].filter(Boolean).join(" ");
      const activityTokens = tokenizeForMatch(expandMatchText(matchText));
      if (!activityTokens.length) return;

      let bestMatch = null;
      let bestScore = 0;

      MCC_MATCH_INDEX.forEach(({ entry, tokens }) => {
  ...
  function formatMccMatchLine(match) {
    if (!match?.entry) return "";
    const base = `${match.entry.mcc} - ${match.entry.activity} (${match.entry.description})`;
    if (!match.teaorCode) return base;
    const teaorDesc = match.teaorDescription ? ` ${match.teaorDescription}` : "";
    return `${base} | TEÁOR ${match.teaorCode}${teaorDesc}`;
  }
  ...
  async function collectPayload() {
    ...
    const mccLines = kyc.matches
      .map((match) => formatMccMatchLine(match))
      .filter(Boolean)
      .join("\n");
