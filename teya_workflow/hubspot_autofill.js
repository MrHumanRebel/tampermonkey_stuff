...
(() => {
  ...
  function addActivityBarButton() {
    const actionRows = Array.from(document.querySelectorAll("div, section"));
    const targetRow = actionRows.find((row) => {
    ...
    if (targetRow.parentElement?.querySelector(`.${BUTTON_WIDE_CLASS}`)) {
      return;
    }
